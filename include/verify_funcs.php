...
<form method='post' action='?logout=0&timezone=-7'>Password: <input
	type='password' name='password' size='10' value='' /> <input
...
Password: <input type='password' name='password1' size='10' value='' />
<br />
